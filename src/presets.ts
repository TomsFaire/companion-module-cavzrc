...
export function GetPresetList(_instance: ZoomRoomsInstance): CompanionPresetDefinitions {
  ...
  // NDI
  presets['ndi_content_off'] = btn('NDI Off', 'NDI', 'setNDIContentOff', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })
  presets['ndi_content_participant'] = btn('NDI Participant', 'NDI', 'setNDIContentParticipant', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })
  presets['ndi_content_gallery'] = btn('NDI Gallery', 'NDI', 'setNDIContentGallery', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })

  // HWIO
  presets['hwio_content_off'] = btn('HWIO Off', 'HWIO', 'setHWIOContentOff', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })
  presets['hwio_content_participant'] = btn('HWIO Participant', 'HWIO', 'setHWIOContentParticipant', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })

  // Dante
  presets['dante_content_off'] = btn('Dante Off', 'Dante', 'setDanteContentOff', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })
  presets['dante_content_mix'] = btn('Dante Mix', 'Dante', 'setDanteContentMix', { targetType: 'roomIndex', roomIndex: 1, channel_num: 1 })
  ...
  // Overlays
  presets['enable_nametag'] = btn('Name tag on', 'Overlays', 'enableNameTagOverlay', { targetType: 'roomIndex', roomIndex: 1 })
  presets['disable_nametag'] = btn('Name tag off', 'Overlays', 'disableNameTagOverlay', { targetType: 'roomIndex', roomIndex: 1 })
  presets['enable_emoji'] = btn('Emoji on', 'Overlays', 'enableEmojiOverlay', { targetType: 'roomIndex', roomIndex: 1 })
  presets['disable_emoji'] = btn('Emoji off', 'Overlays', 'disableEmojiOverlay', { targetType: 'roomIndex', roomIndex: 1 })
